...
To share your website with others, you’ll need to deploy it using GitHub Pages. The full instructions for this process can be found in the Recipes project lesson.
